...
//    var App.prefs.isLoggedIn = false
//    var App.prefs.userEmail = ""
//    var App.prefs.authToken = ""
    ...
    fun registerUser(context: Context, email: String, password: String, complete: (Boolean) -> Unit) {
        ...
        val registerRequest = object : StringRequest(Method.POST, URL_REGISTER, Response.Listener { response ->
            ...
            Log.d("INFO", "URL_REGISTER is $URL_REGISTER")
            complete(false)
        }) {
...
private fun SharedPrefs.requestQueue(context: Context) {
